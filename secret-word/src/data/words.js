export const wordsList = {
    fruta: ["morango", "maçã", "banana", "laranja", "uva", "abacaxi", "kiwi"],
    animal: ["cachorro", "gato", "elefante", "leão", "tigre", "urso", "macaco"],
    cor: ["vermelho", "azul", "verde", "amarelo", "marrom", "cinza", "rosa"],
    país: ["brasil", "argentina", "frança", "alemanha", "japão", "canadá", "austrália"],
    objeto: ["mesa", "cadeira", "computador", "livro", "caneta", "telefone", "copo"],
